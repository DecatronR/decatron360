  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      ...
      try {
        ...
        // Filter properties to include only those in Distress Sale
        const distressSaleProperties = allProperties.filter(
          (property) => property.listingType === "Distress Sale"
        );
        ...
        if (userId) {
          ...
          const updatedProperties = distressSaleProperties.map((property) => {
          ...
          setProperties(
            distressSaleProperties.map((property) => ({
              ...property,
              isFavorite: false,
              favoriteId: null,
            }))
...
export default PropertiesDistressSale;
