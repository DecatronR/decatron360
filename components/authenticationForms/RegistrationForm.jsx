            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded shadow-lg">
                ...
                <div>
                    ...
                    >
                        ...
                        >
                            <path
                                d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm0 2C7.03 4 3 8.03 3 13s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm-2 3h1v7h-1zm1 8v1H9v-1zm0-8h1v1h-1zm1-1v1h-1v-1zm0 2h1v1h-1zm-1-1v1H9v-1zm0 2h1v1h-1zm1 1h-1v1h1z"
                            />
                        </svg>
                        Sign in with Google
                    </button>
