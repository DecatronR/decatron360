...
import SaleForm from "../Properties/SaleForm";
...
describe("SaleForm Component", () => {
  ...
  it("should render the form with correct fields", async () => {
    ...
    expect(screen.getByText(/Add Property For Sale/i)).toBeInTheDocument();
  ...
  it("should display an error message if form submission fails", async () => {
    ...
    fireEvent.submit(screen.getByTestId("sale-form"));
